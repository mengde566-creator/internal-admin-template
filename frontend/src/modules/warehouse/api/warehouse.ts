...
export function confirmItemImport(jobId: string, payload: { revision: number; clientRequestId: string; confirmed: boolean }) { return http.post<ApiResponse<WarehouseItemImportJob>>(`/api/warehouse/item-imports/${jobId}/confirm`, payload) }
