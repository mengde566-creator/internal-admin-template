...
3. 07B启动前技术复核已完成，框架复用、Tool级Artifact授权、消费时Actor重解析、ResumeRef隔离和单迭代单ToolCall规则已写入主设计；下一步只派发07B给研发乙，07C、07D仍不启动。
...
07按07A注册与解耦、07B受信依赖链、07C业务资产归位、07D前端通用壳/学习文档/裁剪证明顺序实施。当前状态为“07A已关闭，07B方案已完善但尚未派发”；客户与订单生产功能、knowledgeSpace、DAG、动态插件和Artifact持久化均不在07范围内。
